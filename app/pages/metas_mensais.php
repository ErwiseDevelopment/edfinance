...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'replicar') {
    try {
        ...
        echo "<script>window.location.href='index.php?pg=metas_mensais&mes=$mes_proximo&msg=replicado';</script>";
        exit;
    } catch (Exception $e) {
...
<div class="container py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <a href="index.php?pg=dashboard" class="text-decoration-none text-muted small fw-bold mb-1"><i class="bi bi-arrow-left"></i> Voltar ao Dashboard</a>
            <h4 class="fw-bold m-0 text-dark">Metas Mensais</h4>
        </div>
        
        <div class="d-flex align-items-center gap-2">
            <a href="index.php?pg=metas_mensais&mes=<?= $mes_anterior ?>" class="btn btn-white border rounded-circle shadow-sm" style="width: 40px; height: 40px; display: grid; place-items: center;"><i class="bi bi-chevron-left"></i></a>
            ...
            <a href="index.php?pg=metas_mensais&mes=<?= $mes_proximo ?>" class="btn btn-white border rounded-circle shadow-sm" style="width: 40px; height: 40px; display: grid; place-items: center;"><i class="bi bi-chevron-right"></i></a>
        </div>
    </div>
