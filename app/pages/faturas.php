...
// Define a cor do cartão atual (ou padrão se não existir)
...
<style>
    ...
    /* Header agora usa variável CSS inline no HTML para cor */
    ...
    /* NOVA CLASSE: Miniatura do Cartão */
    .mini-card-visual {
        ...
        <div class="card-fatura mb-4">
            <div class="card-fatura-header" style="background: <?= $cor_cartao_atual ?>;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge <?= $itens_pendentes_mes > 0 ? 'bg-white text-dark' : 'bg-success text-white' ?> rounded-pill shadow-sm">
                        <?= $itens_pendentes_mes > 0 ? 'ABERTA' : 'PAGA' ?>
                    </span>
                </div>

                <h1 class="fw-bold m-0 display-5">R$ <?= number_format($total_fatura_mes, 2, ',', '.') ?></h1>
