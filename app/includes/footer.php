...
<div class="fab-wrapper" id="menuFlutuante">
    ...
    <div class="fab-list">
        ...
        <a href="index.php?pg=cadastro_conta" class="fab-item" data-label="Nova Conta">
            <i class="bi bi-plus-circle text-success"></i>
        </a>
        <a href="index.php?pg=cadastro_cartao" class="fab-item" data-label="Novo Cartão">
        ...
        <a href="index.php?pg=fluxo_caixa" class="fab-item" data-label="Fluxo de Caixa">
            <i class="bi bi-arrow-left-right" style="color: #6366f1;"></i>
        </a>
        
        <a href="index.php?pg=faturas" class="fab-item" data-label="Minhas Faturas">
            <i class="bi bi-receipt-cutoff" style="color: #8b5cf6;"></i>
        </a>

        <a href="index.php?pg=categorias" class="fab-item" data-label="Categorias">
...
.fab-main { 
    ...
    background: var(--primary-color, #4361ee); border: none; color: white; 
...
.fab-item { 
    ...
    transition: 0.2s; border: 1px solid #f1f5f9; position: relative;
}

.fab-item:hover { transform: scale(1.1); background: #f8fafc; }

/* Tooltip (Rótulo ao lado do ícone) */
.fab-item::after { 
...
/* --- COMPUTADOR (DESKTOP) --- */
/* Mantendo o menu fixo vertical na lateral direita */
...
document.addEventListener('click', function(e) {
    ...
    // Se estiver no mobile e o menu estiver aberto, clica fora fecha
    if (window.innerWidth < 992 && menu && menu.classList.contains('active') && !menu.contains(e.target)) {
